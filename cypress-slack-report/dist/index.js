...
/* harmony import */ var walk_sync__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(953);
/* harmony import */ var walk_sync__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(walk_sync__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _slack_web_api__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(114);
/* harmony import */ var _slack_web_api__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_slack_web_api__WEBPACK_IMPORTED_MODULE_3__);
...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const screenshots = walk_sync__WEBPACK_IMPORTED_MODULE_2__(workdir, { globs: ["**/*.png"] });
            const logs = walk_sync__WEBPACK_IMPORTED_MODULE_2__(workdir, { globs: ["**/*.txt"] });
            ...
            if (include_media) {
                yield Promise.all(screenshots.map(screenshot => slack.files.upload({
                    filename: screenshot,
                    file: Object(fs__WEBPACK_IMPORTED_MODULE_1__.createReadStream)(`${workdir}/${screenshot}`),
                    thread_ts: threadID,
                    channels: channelId
                })));
                yield Promise.all(videos.map(video => slack.files.upload({
                    filename: video,
                    file: Object(fs__WEBPACK_IMPORTED_MODULE_1__.createReadStream)(`${workdir}/${video}`),
                    thread_ts: threadID,
                    channels: channelId
                })));
                yield Promise.all(logs.map(log => slack.files.upload({
                    filename: log,
                    file: Object(fs__WEBPACK_IMPORTED_MODULE_1__.createReadStream)(`${workdir}/${log}`),
                    thread_ts: threadID,
                    channels: channelId
                })));
            }
