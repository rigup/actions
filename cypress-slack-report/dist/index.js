...
/* harmony import */ var https__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(211);
...
/* harmony import */ var url__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(835);
/* harmony import */ var url__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(url__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var walk_sync__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(953);
/* harmony import */ var walk_sync__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(walk_sync__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _slack_web_api__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(114);
/* harmony import */ var _slack_web_api__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_slack_web_api__WEBPACK_IMPORTED_MODULE_5__);
...
function uploadToUrl(uploadUrl, filePath) {
    return __awaiter(this, void 0, void 0, function* () {
        return new Promise((resolve, reject) => {
            const fileStream = Object(fs__WEBPACK_IMPORTED_MODULE_1__.createReadStream)(filePath);
            const fileSize = Object(fs__WEBPACK_IMPORTED_MODULE_1__.statSync)(filePath).size;
            const url = new url__WEBPACK_IMPORTED_MODULE_3__.URL(uploadUrl);
            const options = {
            ...
            const req = https__WEBPACK_IMPORTED_MODULE_2__.request(options, res => {
...
function uploadFileToSlack(slack, filePath, filename, channelId, threadID) {
    return __awaiter(this, void 0, void 0, function* () {
        const fileSize = Object(fs__WEBPACK_IMPORTED_MODULE_1__.statSync)(filePath).size;
        const urlResponse = (yield slack.apiCall("files.getUploadURLExternal", {
            filename,
            length: fileSize
        }));
        yield uploadToUrl(urlResponse.upload_url, filePath);
        yield slack.apiCall("files.completeUploadExternal", {
...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const slack = new _slack_web_api__WEBPACK_IMPORTED_MODULE_5__.WebClient(slack_token);
            const videos = walk_sync__WEBPACK_IMPORTED_MODULE_4__(workdir, { globs: ["**/*.mp4"] });
            const screenshots = walk_sync__WEBPACK_IMPORTED_MODULE_4__(workdir, { globs: ["**/*.png"] });
            const logs = walk_sync__WEBPACK_IMPORTED_MODULE_4__(workdir, { globs: ["**/*.txt"] });
            ...
            if (include_media) {
                yield Promise.all(screenshots.map(screenshot => uploadFileToSlack(slack, `${workdir}/${screenshot}`, screenshot, channelId, threadID)));
                yield Promise.all(videos.map(video => uploadFileToSlack(slack, `${workdir}/${video}`, video, channelId, threadID)));
                yield Promise.all(logs.map(log => uploadFileToSlack(slack, `${workdir}/${log}`, log, channelId, threadID)));
            }
...
var minimatch_1 = __webpack_require__(93);
...
const fsNode = __webpack_require__(747);
const MatcherCollection = __webpack_require__(904);
const ensurePosix = __webpack_require__(26);
